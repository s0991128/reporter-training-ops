...
<header class="meta"><p class="eyebrow">HANDOVER REPORT / V0.12</p><h1>${escapeHtml(trainingName)} 인수인계 보고서</h1><p class="muted">생성일 · ${escapeHtml(formatDate(generatedAt))}</p></header>
